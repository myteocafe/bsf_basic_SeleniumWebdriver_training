...
def select_additional_product(product_id)
  check_box_item = @driver.find_element(:xpath, "//table/tbody/tr/td/input[@type='checkbox' and @id='#{product_id}']")
